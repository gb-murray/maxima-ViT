...
class Loss(nn.Module):
    ...
    def __init__(self):
        ...
        self.scale_factors = torch.tensor([0.20, 0.005, 0.005, 0.1, 0.1, 0.1], dtype=torch.float32)
        ...
        self.centers = torch.tensor([0.15, 0.0425, 0.0375, 0.0, 0.0, 0.0], dtype=torch.float32)
